...
- **Kubernetes**
  ...
  - [Architecture](kubernetes/md-files/Architecture.md)
  - [Components_Failures](kubernetes/md-files/Component_failure.md)
  - [Scheduling, Resources, and Scaling](kubernetes/md-files/Scheduling.md)
  - [Networking & Ingress ](kubernetes/md-files/Networking.md)
  - [Config, Storage, and State](kubernetes/md-files/Config_Stoage.md)
  - [Secrets](kubernetes/md-files/Secrets.md)
